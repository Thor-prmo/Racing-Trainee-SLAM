...
constexpr double kInitCovariance = 1.0;
constexpr double kProcessXy = 0.05;
constexpr double kProcessYaw = 0.03;
constexpr double kProcessVelocity = 0.30;
constexpr double kProcessYawRate = 0.20;

constexpr double kWheelVariance = 0.15;
constexpr double kImuYawRateVariance = 0.05;
...
public:
    ...
    first_imu_(true)
  {
    ...
    association_gate_ = declare_parameter<double>("association_gate", 2.0);
    cone_measurement_stddev_ = declare_parameter<double>("cone_measurement_stddev", 0.25);
    covariance_scale_ = declare_parameter<double>("covariance_scale", kChiSquare95Scale2d);
    min_covariance_diameter_ = declare_parameter<double>("min_covariance_diameter", 0.12);
    max_covariance_diameter_ = declare_parameter<double>("max_covariance_diameter", 12.0);
